---
user-guide-title: Vidéos, cours et Tutorials
user-guide-description: Découvrez Adobe Commerce et Magento Open Source par le biais de vidéos, de cours et de tutoriels.
breadcrumb-title: Cours et Tutorials vidéo
...
# Vidéos, cours et Tutorials Adobe Commerce {#content}
...
+ GraphQL et REST {#graphql-rest}
   + [Présentation de GraphQL](https://experienceleague-review.corp.adobe.com/docs/commerce-learn/graphql-rest/getting-started-graphql.html)
...
+ Outils marketing {#marketing}
   ...
   + [Utilisation de la recherche en direct](../site-management/live-search.md)
