...
+ Adobe Commerce Cloud {#adobe-commerce-cloud}
   + Intégration technique et remise du matériel {#technical-onboarding-hardware-handoff}
      + [Lancer la chronologie du processus](../cloud/launch-process-timeline.md)
...
+ Prise en main {#getting-started}
   ...
   + Créer des produits {#create-products}
      ...
      + [Produit de la carte cadeau](../site-management/create-gift-card-product.md)
...
+ Créateur d’application Adobe Developer {#adobe-developer-app-builder}
   + [Présentation de l’App Builder](../app-builder/introduction-to-app-builder.md)
   ...
   + Créer votre première application App Builder {#first-app}
      ...
      + [Test à l’aide de l’URL de l’App Builder](../app-builder/first-app/testing-app-builder-url.md)
   ...
   + Maillage API {#api-mesh}
      ...
      + [Créer plusieurs maillages API GraphQL sources](../api-mesh/graphql-multiple-source.md)
+ Administration de la boutique {#admin}
   ...
   + Services Adobe Commerce {#adobe-commerce-services}
      + [Configurer Commerce Services Connector](../site-management/configure-adobe-commerce-services-connector.md)
...
+ Gestion des clients {#customers}
   + [Créer des segments de clients](../site-management/customer-segments.md)
...
+ Commandes et exécution {#orders}
   + [Présentation de l’exécution de la boutique](../site-management/store-fulfillment.md)
   + [Gérer le statut de la commande](../site-management/order-status.md)
+ B2B pour Adobe Commerce {#b2b}
   ...
   + Citation {#b2b-quote}
      ...
      + [Notes sur les lignes de devis](../b2b/quote-line-item-notes.md)
...
+ Intelligence commerciale {#mbi}
   ...
   + [Se préparer pour l’avenir](../business-intelligence/prepare-for-future.md)
...
+ Architecture découplée {#headless-architecture}
   + Présentation du découplage {#introduction-to-headless}
      + [Architecture découplée - Session 1](../headless/session-1.md)
   + Présentation de PWA Studio {#introduction}
      + [1 - Aperçu](../pwa/introduction/1-overview.md)
      + [2 - outils du PWA Studio](../pwa/introduction/2-pwa-studio-tools.md)
