---
title: Options commerciales disponibles dans Adobe
description: Comparez les options de déploiement d’Adobe Commerce (On-Prem, Cloud, SaaS et Commerce Optimizer) et apprenez à choisir le modèle approprié pour votre entreprise.
jira: KT-20236
doc-type: tutorial
duration: 360
...
* Vice-président/directeur de Commerce
* Direction technique
* Ingénieurs et ingénieures DevOps/Platform
* Responsable des technologies marketing

## Contenu vidéo

* Comparez les modèles de déploiement Adobe Commerce : On-Prem, Cloud, SaaS et Optimizer.
* Découvrez qui gère l’infrastructure par rapport aux applications dans chaque option.
...
* [&#128279;](https://experienceleague.adobe.com/en/docs/commerce/optimizer/overview){target="_blank"}
