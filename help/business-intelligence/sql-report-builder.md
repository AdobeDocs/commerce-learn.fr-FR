...
>[!TIP]
>
> If you are new to Commerce Intelligence, the [Adobe Commerce Intelligence user guide](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/guide-overview.html?lang=fr){target="_blank"} explains how to aggregate, analyze, and visualize data for stronger business insights.
...
* [Using the SQL Report Builder](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/analyze/sql/sql-rpt-bldr.html?lang=fr){target="_blank"} (Commerce Intelligence user guide)
* [Creating visualizations from SQL queries](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/tutorials/create-visuals-from-sql.html?lang=fr){target="_blank"} (Commerce Intelligence user guide)
