...
- [Création d’un produit de carte-cadeau à partir de l’administrateur Commerce](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-gift-card-create.html){target="_blank"}
